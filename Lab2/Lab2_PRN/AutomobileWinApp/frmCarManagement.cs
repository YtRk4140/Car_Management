using AutomobileLibrary.BussinesObject;
...
namespace AutomobileWinApp
{
    public partial class frmCarManagement : Form
    {
        ...
        private void btnNew_Click(object sender, EventArgs e)
        {
            ...
            frmCarDetails.Show();
            frmCarDetails.FormClosed += btnLoad_Click;
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DialogResult r = MessageBox.Show("Are you sure you want to delete?", "Notification", MessageBoxButtons.YesNo);
